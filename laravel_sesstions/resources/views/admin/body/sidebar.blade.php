        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span></a>
                    <ul class="menu-content">
                        <li><a href="{{asset('backend/starter-kit/ltr/vertical-menu-template-dark/sk-layout-2-columns.html')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="2 columns">2 columns</span></a>
                        </li>
                        <li><a href="{{asset('backend/starter-kit/ltr/vertical-menu-template-dark/sk-layout-fixed-navbar.html')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Fixed navbar">Fixed navbar</span></a>
                        </li>
                        <li><a href="{{asset('backend/starter-kit/ltr/vertical-menu-template-dark/sk-layout-floating-navbar.html')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Floating navbar">Floating navbar</span></a>
                        </li>
                        <li><a href="{{asset('backend/starter-kit/ltr/vertical-menu-template-dark/sk-layout-fixed.html')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Fixed layout">Fixed layout</span></a>
                        </li>
                    </ul>
                </li>
